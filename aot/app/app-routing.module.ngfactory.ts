...
import * as import9 from './heroes.component.ngfactory';
import * as import10 from './hero-detail.component.ngfactory';
...
import * as import16 from '../../app/hero-detail.component';
import * as import17 from '../../app/dashboard.component';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[
      import9.HeroesComponentNgFactory,
      import10.HeroDetailComponentNgFactory,
  ...
  get _LocationStrategy_4():any {
    if ((this.__LocationStrategy_4 == (null as any))) { (this.__LocationStrategy_4 = import2.provideLocationStrategy(this.parent.get(import12.PlatformLocation),this.parent.get(import13.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_3)); }
  ...
  get _NgModuleFactoryLoader_8():import6.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_8 == (null as any))) { (this.__NgModuleFactoryLoader_8 = new import6.SystemJsNgModuleLoader(this.parent.get(import14.Compiler),this.parent.get(import6.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == (null as any))) { (this.__ROUTES_9 = [[
        ...
        {
          path: 'dashboard',
          component: import17.DashboardComponent
        }
  ...
  get _Router_10():any {
    if ((this.__Router_10 == (null as any))) { (this.__Router_10 = import2.setupRouter(this.parent.get(import18.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import14.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3)); }
  ...
  get _APP_BOOTSTRAP_LISTENER_16():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_16 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_16 = [import2.initialRouterNavigation(this._Router_10,this.parent.get(import18.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)]); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import23.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_16; }
