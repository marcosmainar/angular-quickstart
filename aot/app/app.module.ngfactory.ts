...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _InMemoryWebApiModule_9:import10.InMemoryWebApiModule;
  ...
  __InMemoryDbService_50:import29.InMemoryDataService;
  __InMemoryBackendConfig_51:any;
  __XHRBackend_52:any;
  __RequestOptions_53:import30.BaseRequestOptions;
  __Http_54:any;
  __BrowserXhr_55:import31.BrowserXhr;
  __ResponseOptions_56:import32.BaseResponseOptions;
  __XSRFStrategy_57:any;
  __HeroService_58:import33.HeroService;
  __UserService_59:import34.UserService;
  __ContactService_60:import35.ContactService;
  ...
  get _APP_ID_19():any {
    if ((this.__APP_ID_19 == (null as any))) { (this.__APP_ID_19 = import41._appIdRandomProviderFactory()); }
  ...
  get _EventManager_23():import17.EventManager {
    if ((this.__EventManager_23 == (null as any))) { (this.__EventManager_23 = new import17.EventManager(this._EVENT_MANAGER_PLUGINS_22,this.parent.get(import44.NgZone))); }
  ...
  get _RootRenderer_27():any {
    if ((this.__RootRenderer_27 == (null as any))) { (this.__RootRenderer_27 = import45._createConditionalRootRenderer(this._DomRootRenderer_26,this.parent.get(import45.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_37():any {
    if ((this.__LocationStrategy_37 == (null as any))) { (this.__LocationStrategy_37 = import7.provideLocationStrategy(this.parent.get(import46.PlatformLocation),this.parent.get(import47.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_36)); }
  ...
  get _InMemoryDbService_50():import29.InMemoryDataService {
    if ((this.__InMemoryDbService_50 == (null as any))) { (this.__InMemoryDbService_50 = new import29.InMemoryDataService()); }
    return this.__InMemoryDbService_50;
  }
  get _InMemoryBackendConfig_51():any {
    if ((this.__InMemoryBackendConfig_51 == (null as any))) { (this.__InMemoryBackendConfig_51 = (null as any)); }
    return this.__InMemoryBackendConfig_51;
  }
  get _XHRBackend_52():any {
    if ((this.__XHRBackend_52 == (null as any))) { (this.__XHRBackend_52 = import10.inMemoryBackendServiceFactory(this,this._InMemoryDbService_50,this._InMemoryBackendConfig_51)); }
    return this.__XHRBackend_52;
  }
  get _RequestOptions_53():import30.BaseRequestOptions {
    if ((this.__RequestOptions_53 == (null as any))) { (this.__RequestOptions_53 = new import30.BaseRequestOptions()); }
  ...
  get _BrowserXhr_55():import31.BrowserXhr {
    if ((this.__BrowserXhr_55 == (null as any))) { (this.__BrowserXhr_55 = new import31.BrowserXhr()); }
    return this.__BrowserXhr_55;
  }
  get _ResponseOptions_56():import32.BaseResponseOptions {
    if ((this.__ResponseOptions_56 == (null as any))) { (this.__ResponseOptions_56 = new import32.BaseResponseOptions()); }
    return this.__ResponseOptions_56;
  }
  get _XSRFStrategy_57():any {
    if ((this.__XSRFStrategy_57 == (null as any))) { (this.__XSRFStrategy_57 = import9._createDefaultCookieXSRFStrategy()); }
    return this.__XSRFStrategy_57;
  }
  get _HeroService_58():import33.HeroService {
    if ((this.__HeroService_58 == (null as any))) { (this.__HeroService_58 = new import33.HeroService(this._Http_54)); }
    return this.__HeroService_58;
  }
  get _UserService_59():import34.UserService {
    if ((this.__UserService_59 == (null as any))) { (this.__UserService_59 = new import34.UserService()); }
    return this.__UserService_59;
  }
  get _ContactService_60():import35.ContactService {
    if ((this.__ContactService_60 == (null as any))) { (this.__ContactService_60 = new import35.ContactService()); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import51.Router,(null as any)));
    ...
    this._ApplicationRef__16 = new import14.ApplicationRef_(this.parent.get(import44.NgZone),this.parent.get(import52.Console),this,this._ErrorHandler_13,this,this._ApplicationInitStatus_14,this.parent.get(import13.TestabilityRegistry,(null as any)),this._Testability_15);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import10.InMemoryWebApiModule)) { return this._InMemoryWebApiModule_9; }
    if ((token === import1.AppModule)) { return this._AppModule_10; }
    if ((token === import53.LOCALE_ID)) { return this._LOCALE_ID_11; }
    ...
    if ((token === import57.RootRenderer)) { return this._RootRenderer_27; }
    if ((token === import20.DomSanitizer)) { return this._DomSanitizer_28; }
    if ((token === import58.Sanitizer)) { return this._Sanitizer_29; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_30; }
    if ((token === import59.IterableDiffers)) { return this._IterableDiffers_31; }
    if ((token === import60.KeyValueDiffers)) { return this._KeyValueDiffers_32; }
    ...
    if ((token === import47.LocationStrategy)) { return this._LocationStrategy_37; }
    ...
    if ((token === import61.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_41; }
    if ((token === import62.ROUTES)) { return this._ROUTES_42; }
    if ((token === import51.Router)) { return this._Router_43; }
    if ((token === import63.ActivatedRoute)) { return this._ActivatedRoute_44; }
    ...
    if ((token === import41.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_49; }
    if ((token === import64.InMemoryDbService)) { return this._InMemoryDbService_50; }
    if ((token === import64.InMemoryBackendConfig)) { return this._InMemoryBackendConfig_51; }
    if ((token === import65.XHRBackend)) { return this._XHRBackend_52; }
    if ((token === import30.RequestOptions)) { return this._RequestOptions_53; }
    if ((token === import66.Http)) { return this._Http_54; }
    if ((token === import31.BrowserXhr)) { return this._BrowserXhr_55; }
    if ((token === import32.ResponseOptions)) { return this._ResponseOptions_56; }
    if ((token === import67.XSRFStrategy)) { return this._XSRFStrategy_57; }
    if ((token === import33.HeroService)) { return this._HeroService_58; }
    if ((token === import34.UserService)) { return this._UserService_59; }
    if ((token === import35.ContactService)) { return this._ContactService_60; }
